...
>
> **Валидация:** Система должна проверять соответствие статей расходов в строках авансового отчета (AdvanceReportItem.item) статье расходов, указанной при выдаче подотчетных средств (AdvancePayment.expense_item)
>
